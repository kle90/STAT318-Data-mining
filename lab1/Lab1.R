## STAT318/462 Lab1: Introduction to R 
#
...
## Loading Data
# I have posted the Auto data on Learn as a .csv file. You should be 
# able to read in the data if you're in the proper directory.
